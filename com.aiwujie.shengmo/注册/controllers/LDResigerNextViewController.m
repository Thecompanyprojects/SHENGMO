...
-(void)createFooterView{
    ...
    UILabel *warnLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 0, WIDTH - 20, 20)];
    ...
    _nextButton = [[UIButton alloc] initWithFrame:CGRectMake(10, 60, WIDTH - 20, 40)];
    
    [_nextButton setTitle:@"下一步" forState:UIControlStateNormal];
    
    [_nextButton setTitleColor:[UIColor colorWithRed:183/255.0 green:183/255.0 blue:183/255.0 alpha:1] forState:UIControlStateNormal];
    
    _nextButton.userInteractionEnabled = NO;
    
    [_nextButton setBackgroundColor:[UIColor colorWithRed:239/255.0 green:240/255.0 blue:242/255.0 alpha:1]];
...
-(void)status{
    ...
    if (self.nameField.text.length != 0 && self.headUrl.length != 0 && self.sex.length != 0 && self.birthday.length != 0 && self.height.length != 0 && self.weight.length != 0 && self.role.length != 0) {
        ...
        [self.nextButton setTitleColor:[UIColor colorWithRed:183/255.0 green:183/255.0 blue:183/255.0 alpha:1] forState:UIControlStateNormal];
        
        [self.nextButton setBackgroundColor:[UIColor colorWithRed:239/255.0 green:240/255.0 blue:242/255.0 alpha:1]];
