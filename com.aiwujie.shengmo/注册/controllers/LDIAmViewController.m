    ...
    for (UIButton *btn in cell.contentView.subviews) {
        ...
        if (button.tag == btn.tag) {
            ...
            if (button.tag/100 == 0) {
                ...
                _along = [NSString stringWithFormat:@"%ld",button.tag%100 + 1];
                
                [_array replaceObjectAtIndex:button.tag/100 withObject:_dataArray[button.tag/100][button.tag%100]];
                
            }else if (button.tag/100 == 1){
            
                _experience = [NSString stringWithFormat:@"%ld",button.tag%100 + 1];
                
                 [_array replaceObjectAtIndex:button.tag/100 withObject:_dataArray[button.tag/100][button.tag%100]];
                
            }else if (button.tag/100 == 4){
            
                _culture = [NSString stringWithFormat:@"%ld",
                            button.tag%100 + 1];
                ...
                _monthly = [NSString stringWithFormat:@"%ld",button.tag%100 + 1];
...
-(void)status{
    ...
    if (self.along.length != 0 && self.experience.length != 0 && self.culture.length != 0 && self.monthly.length != 0 && self.introduce.length != 0) {
        ...
        [self.completeButton setTitleColor:[UIColor colorWithRed:183/255.0 green:183/255.0 blue:183/255.0 alpha:1] forState:UIControlStateNormal];
        
        [self.completeButton setBackgroundColor:[UIColor colorWithRed:239/255.0 green:240/255.0 blue:242/255.0 alpha:1]];
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(10, 5, WIDTH/2, 25)];
    ...
    UILabel *hintLabel = [[UILabel alloc] initWithFrame:CGRectMake(WIDTH/2 , 5, WIDTH/2 - 10, 25)];
...
-(UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section{
    ...
    if (section == _dataArray.count - 1) {
        ...
        _completeButton = [[UIButton alloc] initWithFrame:CGRectMake(10, 60, WIDTH - 20, 40)];

        
        [_completeButton setTitle:@"完成" forState:UIControlStateNormal];
        
        [_completeButton setTitleColor:[UIColor colorWithRed:183/255.0 green:183/255.0 blue:183/255.0 alpha:1] forState:UIControlStateNormal];
        
        _completeButton.userInteractionEnabled = NO;
        
        [_completeButton setBackgroundColor:[UIColor colorWithRed:239/255.0 green:240/255.0 blue:242/255.0 alpha:1]];
