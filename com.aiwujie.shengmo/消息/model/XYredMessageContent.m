...
static NSString *groupenvelopeinfo = @"ec:groupenvelopeinfo";
...
{
    XYredMessageContent *msg = [[XYredMessageContent alloc] init];
    NSString *message = dict[@"message"];
    msg.message = message;
    msg.isopen = dict[@"isopen"];
    msg.orderid = dict[@"orderid"];
    return msg;
}
