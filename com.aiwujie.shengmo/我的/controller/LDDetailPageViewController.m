...
- (void)backButtonOnClick{
    ...
    if (self.index==3) {
        ...
        UIAlertAction *action0 = [UIAlertAction actionWithTitle:@"金魔豆兑换推顶卡" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
           ...
           NSArray *TopcardArray = @[[NSString stringWithFormat:@"%@%@%@",@"(剩余",newStr,@"金魔豆)"],@"1张/300金魔豆", @"3张/830金魔豆(9.5折)", @"10张/2700金魔豆(9.1折)", @"30张/7650金魔豆(8.6折)", @"90张/21600金魔豆(8折)", @"270张/60750金魔豆(7.5折)"];
