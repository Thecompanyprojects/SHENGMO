...
-(void)iscanexchange
{
    ...
    [NetManager afPostRequest:url parms:params finished:^(id responseObj) {
        if ([[responseObj objectForKey:@"retcode"] intValue]==2000) {
            ...
            self.topView.frame = CGRectMake(0, ADVERTISEMENT+98, WIDTH, 50);
            self.pageViewController.view.frame = CGRectMake(0, 148+ADVERTISEMENT, self.view.frame.size.width, self.view.frame.size.height-ADVERTISEMENT-200);
        ...
        else
        {
            ...
            self.topView.frame = CGRectMake(0, 0+98, WIDTH, 50);
            self.pageViewController.view.frame = CGRectMake(0, 148, self.view.frame.size.width, self.view.frame.size.height-148);
        ...
        self.giveView.frame = CGRectMake(0, 0, WIDTH, 98);
        self.topView.frame = CGRectMake(0, 0+98, WIDTH, 50);
        self.pageViewController.view.frame = CGRectMake(0, 148, self.view.frame.size.width, self.view.frame.size.height-50);
    }];
}
